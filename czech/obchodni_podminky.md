...
- Trisbee s.r.o., se sídlem Vokovice, K Červenému vrchu 678/1, PSČ 160 00, IČO: 04775660, vedená v OR u Městského soudu v Praze pod spisovou značkou C 306886 (Provozovatel nebo my), jako poskytovatel platebních služeb. Více si o nás přečtete v článku 5.5.

- Každý, kdo vyjádří souhlas s těmito obchodními podmínkami, aby mohl používat platební služby Provozovatele (Uživatel).

- Každý obchodník, který s Provozovatelem uzavře smlouvu o poskytování platebních služeb k přijímání plateb (Obchodník).

- Každý, kdo pomocí Aplikace, Pluginu nebo API platí Obchodníkovi pomocí systému Trisbee a přitom nevyužívá platební služby Provozovatele (Klient Obchodníka).
...
**Varianta (B): Platím kartou za cokoliv**
...
**Varianta (C): Vedení platebního účtu s možností platit ostatním Uživatelům (mimo Obchodníky) za jejich zboží a služby (Plátce neplatí Provozovateli žádný poplatek, tj. služba je zdarma)**
...
Provozovatel přijímá platební prostředky Platebním terminálem za Obchodníka na svůj bankovní účet a nejpozději následující pracovní den je odesílá na Obchodníkův účet u banky, který Obchodník zadal při uzavření smlouvy nebo prostřednictvím mobilní aplikace Trisbee Go, pokud to umožňuje, nebo jiným způsobem odsouhlaseným Provozovatelem.
...
- Obchodník bere na vědomí, že systém Trisbee je chráněn autorským právem. Obchodník se zavazuje, že nebude vykonávat žádnou činnost, která by mohla jemu nebo třetím osobám umožnit neoprávněný zásah do či neoprávněné užití systému Trisbee. Obchodník není oprávněn při využívání systému Trisbee používat mechanismy, programové vybavení nebo jiné postupy, které by mohly mít negativní vliv na provoz systému Trisbee. Systém Trisbee je možné užívat jen v souladu s jeho určením.

- Obchodník musí viditelně v provozovně umístit logo systému Trisbee, a to jak zvenčí (např. na výloze, dveřích) tak i uvnitř v provozovně popř. u pokladny a dále informaci o tom, že je možné platit kartou prostřednictvímmobilního telefonu prostřednictvím systému Trisbee. Provozovatel poskytne Obchodníkovi potřebné materiály k vyvěšení a to např. ve formě samolepek, v emailové podobě apod.

### 4.7 Dostupnost služeb

Provozovatel negarantuje žádný konkrétní rozsah ani dostupnost platebních služeb Trisbee. Provozovatel je v rámci pravidelné údržby Trisbee, jakož i při jejich technologických změnách zejména oprávněn omezit, popřípadě zcela přerušit provoz Platebního terminálu a služeb Trisbee. Uživateli při takovém omezení či přerušení provozu či jiným technickým potížím Platebního terminálu nenáleží žádná náhrada újmy.
