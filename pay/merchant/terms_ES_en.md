...
**3.5.1.**	Trisbee charges the Merchant a service fee (hereinafter referred to as the “Fee”) depending on the services selected by the Merchant and according to the selected service conditions. Certain services are under the set conditions provided by Trisbee free of charge. The amount of the Fee is always governed by the current Trisbee price list available on the website [https://www.trisbee.com/es/ES/precios](https://www.trisbee.com/es/ES/precios). 
