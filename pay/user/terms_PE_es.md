...
*  haciendo transferencia desde billetera de dinero electrónico, 
*  o haciendo transferencia mediante una tarjeta (débito o crédito). 
...
**2.1.6. TRISBEE** tiene derecho a no permitir o terminar la prestación del servicio al **USUARIO**, en caso este haya incumplido con los términos y condiciones contenidos en el presente documento.

**2.1.7. TRISBEE** está autorizado de no permitir al **USUARIO** utilizar los servicios de pago si es que estos son usados ilegalmente, o si este usa lenguaje ofensivo contra **TRISBEE** o contra cualquier empleado de Trisbee o agente actuando en su nombre, o si el **USUARIO** viola los Términos y Condiciones del Usuario. **TRISBEE** también está autorizado a prevenir que el **USUARIO** use sus servicios de pago si es declarado en insolvencia o si se inician procesos de ejecución en su contra. De igual manera, **TRISBEE** está facultado a finalizar sus servicios de pago en caso el **USUARIO** muera o sea declarado muerto por la autoridad competente.

**2.1.8.** En caso la relación contractual entre **TRISBEE** y el **USUARIO** finalice, se recomienda al **USUARIO** remover la Aplicación de todos sus dispositivos por razones de seguridad.
...
2.2.7. El **USUARIO** puede encontrar más información sobre la concesión de dichas bonificaciones y sus montos en la Aplicación. Las condiciones para el otorgamiento de bonificaciones se encuentran publicadas en el sitio web [www.trisbee.pe](http://www.trisbee.pe).
...
(i) mediante transferencia desde la cuenta bancaria del **USUARIO** en la entidad financiera correspondiente, o

(ii) mediante una tarjeta de pago seleccionada (débito o crédito) del **USUARIO** emitida para la cuenta bancaria del **USUARIO** en su entidad financiera, o emitida por otro emisor autorizado de tarjetas de pago, o

(iii) mediante recarga con efectivo en Agentes registrados con Trisbee para tal propósito, o en Agentes de terceras empresas con las que Trisbee tiene acuerdos de alianza y/o colaboración para tal propósito. En este caso, el **USUARIO** reconoce y declara que el efectivo utilizado para efectos de la referida recarga no proviene del lavado de activos, financiamiento del terrorismo y/u otras actividades ilícitas.
...
(ii) **TRISBEE** se comunica ―por teléfono, SMS y/o correo electrónico― con el **USUARIO** y/o el **NEGOCIO**, solicitando más información sobre la orden de pago ingresada y la presentación de los documentos de respaldo relacionados con la transacción. 

2.5.2. El **USUARIO** reconoce y comprende que **TRISBEE** tiene derecho a solicitar al **USUARIO** y/o **NEGOCIO** que le comuniquen los hechos y le proporcionen todos los documentos relevantes relacionados con la orden de pago ingresada en la Aplicación del **USUARIO**. Tanto el **USUARIO** como el **NEGOCIO** están obligados a brindar a **TRISBEE** una cooperación adecuada y oportuna. La cooperación adecuada significa el suministro de información y documentos completos, imparciales y veraces relacionados con la transacción de pago verificada. La cooperación oportuna significa la cooperación brindada sin demora y a más tardar al final del tercer día hábil posterior al día en que **TRISBEE** solicitó de manera demostrable la cooperación de las personas interesadas.

2.5.3. En caso el **USUARIO** y el **NEGOCIO**, conjunta o separadamente, permanezcan fuera de contacto o no brinden información o esta es insuficiente, distorsionada o engañosa sobre la transacción de pago verificada dentro del plazo especificado en el numeral 2.5.2., **TRISBEE** podrá considerar la transacción como sospechosa y riesgosa y, por tanto, podrá rechazar el procesamiento de la orden de pago ingresada por el **USUARIO**. El rechazo de la transacción por parte de **TRISBEE** se notificará sin demora al **USUARIO** y/o al **NEGOCIO**. El monto ingresado por el **USUARIO** en la orden de pago y bloqueado por **TRISBEE** para la liquidación de la transacción de pago en cuestión no se deduce de la Cuenta de Pago del **USUARIO** y posteriormente se liberará para pagos futuros.
...
2.6.2. Si el **USUARIO** considera que un pago específico acreditado a su cuenta bancaria no fue ingresado a la Aplicación por este o por una persona autorizada por él, o que se beneficia al **NEGOCIO** equivocado o el monto dinerario es incorrecto, el **USUARIO** podrá quejarse de la transacción de pago ante **TRISBEE**.

2.6.3. El **USUARIO** tiene derecho a presentar una queja sobre una transacción de pago específica ante **TRISBEE** sin demoras indebidas después de conocer el motivo de la reclamación.

2.6.4. **TRISBEE** puede requerir que se complete un formulario de reclamo de transacción de pago. Si el formulario no está disponible, la queja del **USUARIO** deberá incluir al menos la siguiente información:
...
2.6.6. Después de examinar todos los hechos y documentos, **TRISBEE** decidirá sobre la solución de la queja concluyendo que esta es:

(i) PROCEDENTE: informando de ello al **USUARIO** y tomando inmediatamente las acciones necesarias que conduzcan a la eliminación del estado reclamado de la transacción de pago.

(ii) IMPROCEDENTE: informando de ello al **USUARIO** y justificando el razonamiento de la decisión.

(iii) PARCIALMENTE PROCEDENTE: informando de ello al **USUARIO**, especificando la parte procedente e improcedente, así como tomando inmediatamente las acciones necesarias para eliminar el extremo de la queja declarado procedente.

2.6.7. El **NEGOCIO** tiene derecho a proceder, por analogía, de conformidad con el artículo 2.6.3. y siguientes de estos Términos y Condiciones, si asumen que un pago realizado a favor de su cuenta bancaria o Cuenta de Pago no concuerda con la orden de pago ingresada por el **USUARIO** y notificada en la Aplicación, o si no han recibido el pago ingresado por el Usuario en la Aplicación.

2.6.8. Si el **USUARIO** solicita la cancelación de una orden de pago ingresada cuando la transacción aún no ha sido procesada por **TRISBEE**, o el reembolso de un pago que ya ha sido procesado y el monto del pago ya ha sido enviado o acreditado al **NEGOCIO**, el **USUARIO** deberá indicar la siguiente información:
...
(ii) Por conducta negligente, que incluye, entre otros, la seguridad insuficiente del dispositivo en el que está instalada la Aplicación para que un tercero no pueda acceder a información sobre transacciones de pago registradas en la Aplicación sin la autorización otorgada por el **USUARIO**.

(iii) Al no informar a **TRISBEE** sobre los hechos relacionados con transacciones de pago no autorizadas a una persona distinta del **USUARIO**, si este descubre dichos hechos o debería haberlos descubierto de haber actuado con diligencia razonable.

3.1.2. **TRISBEE** es totalmente responsable ante el **USUARIO** por la mediación adecuada y oportuna de cualquier transacción de pago ingresada con éxito por este (orden de pago) si esta no se considera sospechosa y/o riesgosa. Sin embargo, **TRISBEE** no se hace responsable de los daños que se hayan producido:
...
(iv) Por acciones de **TRISBEE** que constituyan procedimientos estándar de mediación de servicios de pago que el **USUARIO** debe conocer si se familiarizó con el contenido de estos Términos y Condiciones del Usuario.
...
3.2.2. Si el asunto no permite demoras (por ejemplo, verificación de una transacción sospechosa o riesgosa), el **USUARIO**  reconoce que también puede ser contactado por **TRISBEE** por teléfono, vía SMS al número de teléfono registrado en la Aplicación o a través de la red social Facebook, o de otra manera adecuada.
...
3.7.3. Los presentes Términos y Condiciones del Usuario se regirán e interpretarán de conformidad con las disposiciones normativas vigentes y aplicables en la República del Perú a las operaciones que involucran los servicios de **TRISBEE**. 
...
3.8.5. Todos los derechos y obligaciones que surjan de la relación contractual entre el **USUARIO** y **TRISBEE**, cuyo contenido está previsto en los Términos y Condiciones del Usuario, se rigen por las leyes peruanas, independientemente de dónde se haya realizado el acceso al servicio de pago. 

3.8.6. Si alguna de las disposiciones de los Términos y Condiciones del Usuario es o se vuelve inválida o ineficaz, dicha disposición será reemplazada por una disposición que sea lo más cercana posible al propósito económico de la disposición previa. La invalidez o ineficacia de cualquier disposición no afectará en modo alguno a la validez y eficacia de las demás disposiciones del presente documento. 
