...
**3.8.2.** The agreement between the User and Trisbee is concluded for an indefinite period. Both Trisbee and the User are entitled to terminate the agreement at any time by notifying the other party. Termination of the operation of the Trisbee payment system is also considered termination of the Agreement.

**3.8.3.** The agreement is terminated upon delivery of the notice to the other party. In the event that the User or Trisbee have any due and outstanding commitments to the other party, the parties are obliged to settle such commitments no later than 1 month from the date of the agreement termination.
