...
3.3.4.	Trisbee will guide the User through the identification procedure either directly in the Application or via email messages containing relevant instructions and guidelines. In case of any confusion regarding the identification procedure, the User may use Trisbee customer support; the contacts are listed both in the Application and on www.trisbee.com website.
...
A request to cancel the payment transaction and arequest for a refund may be submitted no later than 3 months from the date that the User entered the payment order in question. 
...
These Terms and Conditions enter into force and take effect on 1 November 2022.
